...
- [X] Upgrade support to Emacs version > 29.1.  Now =use-package= is part of
  Emacs,
  - [X] Change [[file:~/work/emacs/xorns/horns/xorns-packages.el::defun >>=package/ensure (package][>>=package/ensure]] function to test =(require package nil
